...
const Banner = () => {
  return (
   <section className='lg:max-w-6xl mx-auto flex flex-col z-0 items-center justify-center py-28 sm:pt-32 transition-all animate-in' >
    ...
    <h2 className='text-center px-4 lg:px-0 lg:max-w-4xl'>Convert your video or voice into a Blog Post in seconds with the power of AI!
</h2>
...
<span className='relative'>Get VidCraft</span>
